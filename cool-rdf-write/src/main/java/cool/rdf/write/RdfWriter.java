...
/**
 * The RDF Writer is used to serialize RDF documents into various formats, while using configurable
 * formatting for
...
public class RdfWriter {
   ...
   /**
    * Writes an RDF document given by an input URL, to an output stream using a writing/formatting
    * configuration
    *
   ...
   public Try<Void> write( final URL inputUrl, final OutputStream output, final Configuration configuration ) {
      if ( inputUrl.getProtocol().equalsIgnoreCase( "http" ) || inputUrl.getProtocol().equalsIgnoreCase( "https" ) ) {
         try {
            ...
            return write( new ByteArrayInputStream( document.getBytes() ), output, configuration );
   ...
   /**
    * Writes an RDF document given by an input stream, to an output stream using a writing/formatting
    * configuration
    *
