...
public interface RdfModel extends Model {
   ...
   /**
    * Loads an RDF model in a given syntax from an input stream, with a given base URI. The stream is
    * not closed.
    *
    * @param input the input stream
    * @param syntax the syntax
   ...
   /**
    * Similar to {@link Model#listNameSpaces()}, list all namespaces used by predicates and types in
    * the model.
    *
   ...
   /**
    * Similar to {@link Model#listResourcesWithProperty(Property)}, list all resources in this model
    * that have the
    * property.
    *
   ...
   /**
    * Similar to {@link Model#listResourcesWithProperty(Property, RDFNode)}, list all resources in this
    * model that have
   ...
   /**
    * Similar to {@link Model#listObjectsOfProperty(Resource, Property)}, list the values of a property
    * of a resource.
    *
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listLiteralStatements(Resource, Property, boolean)},
    * list
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listLiteralStatements(Resource, Property, char)}, list
    * statements with given subject, predicate and object values.
    *
    * @param subject the subject
    * @param predicate the predicate
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listLiteralStatements(Resource, Property, long)}, list
    * statements with given subject, predicate and object values.
    *
    * @param subject the subject
    * @param predicate the predicate
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listLiteralStatements(Resource, Property, int)}, list
    * statements with given subject, predicate and object values.
    *
    * @param subject the subject
    * @param predicate the predicate
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listLiteralStatements(Resource, Property, float)}, list
    * statements with given subject, predicate and object values.
    *
    * @param subject the subject
    * @param predicate the predicate
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listLiteralStatements(Resource, Property, double)},
    * list
    * statements with given subject, predicate and object values.
    *
    * @param subject the subject
   ...
   /**
    * Similar to {@link org.apache.jena.rdf.model.ModelCon#listStatements(Resource, Property, String)},
    * list statements
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listStatements(Resource, Property, String, String)},
    * list
    * statements with given subject, predicate and object values.
    *
    * @param subject the subject
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listResourcesWithProperty(Property, boolean)}, list the
    * resources in this model which have value o' for property p, where o' is the type literal
    * corresponding to o.
    *
   ...
   /**
    * Similar to {@link org.apache.jena.rdf.model.ModelCon#listResourcesWithProperty(Property, long)},
    * list the
    * resources in this model which have value o' for property p, where o' is the type literal
    * corresponding to o.
    *
   ...
   /**
    * Similar to {@link org.apache.jena.rdf.model.ModelCon#listResourcesWithProperty(Property, char)},
    * list the
    * resources in this model which have value o' for property p, where o' is the type literal
    * corresponding to o.
    *
   ...
   /**
    * Similar to {@link org.apache.jena.rdf.model.ModelCon#listResourcesWithProperty(Property, float)},
    * list the
    * resources in this model which have value o' for property p, where o' is the type literal
    * corresponding to o.
    *
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listResourcesWithProperty(Property, double)}, list the
    * resources in this model which have value o' for property p, where o' is the type literal
    * corresponding to o.
    *
    * @param p the property
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listResourcesWithProperty(Property, Object)}, list the
    * resources in this model which have value o' for property p, where o' is the type literal
    * corresponding to o.
    *
    * @param p the property
   ...
   /**
    * Similar to {@link org.apache.jena.rdf.model.ModelCon#listSubjectsWithProperty(Property, String)},
    * list subjects
   ...
   /**
    * Similar to
    * {@link org.apache.jena.rdf.model.ModelCon#listSubjectsWithProperty(Property, String, String)},
    * list
