...
/**
 * A <a href="https://picocli.info/#_mixing_options_and_positional_parameters">mixin</a> for logging
 * functionality that
...
public class LoggingMixin {
   ...
   /**
    * Gets the configured logging verbosity in raw format, with one array entry for every stacked -v
    * occurrence
    *
