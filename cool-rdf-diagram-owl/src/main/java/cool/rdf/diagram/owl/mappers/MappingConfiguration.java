...
public interface MappingConfiguration {
   ...
   /**
    * The OWL class expression mapper translates OWL class expressions (declarations, but also unions,
    * intersections
    * etc.) to graphs
    *
    * @return the mapper
   ...
   /**
    * The OWL object mapper unifies the interfaces for various other mappers, and translates the
    * corresponding OWL
    * objects to graphs
    *
    * @return the mapper
   ...
   /**
    * The OWL entity mapper translates structural OWL elements such as classes, properties and
    * individuals, to graphs
    *
    * @return the mapper
    */
   ...
   /**
    * The OWL annotation subject mapper translates annotation subjects (i.e., annotated elements) to
    * graphs
    *
    * @return the mapper
    */
   ...
   /**
    * The OWL data printer translates data axioms, such as data unions and complements, to expression
    * String
    * representations
    *
    * @return the printer
   ...
   /**
    * The OWL property expression printer translates OWL object properties and data properties to
    * expression String
    * representations
    *
    * @return the printer
