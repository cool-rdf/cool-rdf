...
/**
 * SVG post processor that embeds the 'owlcli' font used for the element type and disjoint union
 * symbols as a data URI.
...
public class FontEmbedder implements Function<Try<String>, Try<String>> {
   /**
    * This is the encoded symbol font that contains exactly the glyphs used in the diagrams. The steps
    * to obtain this
    * are:
    * <ol>
    * <li>Install fonttools (pip3 install fonttools) to get the pyftsubset command</li>
    * <li>Create a template font from an existing font file that contains glyphs for the used code
    * points: pyftsubset somefont.otf --output-file=owlcli.otf --unicodes-file=<(echo U+02B24 U+025AC
    * U+025C6 U+026AC U+026AD)</li>
    * <li>Adjust the glyphs using fontforge, File->Generate Fonts... save as .woff</li>
    * <li>cat owlcli.woff | base64 -w 0</li>
    * </ol>
    */
   // @formatter:off
