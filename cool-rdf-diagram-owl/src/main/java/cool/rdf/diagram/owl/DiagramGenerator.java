...
/**
 * Main diagram generator class: Loads an ontology, initializes and calls the
 * {@link GraphvizGenerator} to transform the
 * ontology into a Graphviz document, writes the document to a file and calls the Graphviz (dot)
 * binary.
 */
public class DiagramGenerator {
   ...
   /**
    * Performs diagram generation for an input ontology. The result is either written to a given
    * {@link OutputStream}
