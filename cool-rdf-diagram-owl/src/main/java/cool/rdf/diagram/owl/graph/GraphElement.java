...
public interface GraphElement {
    ...
    */
   default <T extends GraphElement> boolean is( final Class<T> clazz ) {
    ...
    */
   default <T extends GraphElement> T as( final Class<T> clazz ) {
      return clazz.cast( this );
   }

   /**
    * Returns a view to this graph element: A stream containing this object cast to the given subclass
    * if possible,
    ...
    * @return the stream
    */
   default <T extends GraphElement> Stream<T> view( final Class<T> clazz ) {
      return is( clazz ) ? Stream.of( as( clazz ) ) : Stream.empty();
   }
