...
/**
 * Implements a graph transformation that removes all nodes of type {@link IRIReference} from a
 * graph and replaces them
 * with the corresponding direct links to the referenced nodes where possible, and with literal
