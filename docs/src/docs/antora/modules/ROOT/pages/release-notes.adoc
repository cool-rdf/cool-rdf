...
Cool RDF 1.0.0 merges and updates the previously separate projects _owl-cli_ and _turtle-formatter_,
...
1. Change your Maven coordinates from `de.atextor:turtle-formatter:1.2.16` to `cool.rdf:cool-rdf-formatter:1.0.0`.
