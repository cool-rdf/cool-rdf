...
The latest version is *{release-version}*. Download here: *https://github.com/atextor/owl-cli/releases/download/{release-tag}/owl-cli-{release-version}.jar[cool-rdf-cli-{release-version}.jar]*
